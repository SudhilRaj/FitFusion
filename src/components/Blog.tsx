  ...
  return (
    <section id='blog' className=' w-full'>
      <div className=' max-container padding-hero-y padding-x'>
        <p className=' text-[#e94057] relative before:absolute before:w-20 before:h-1 before:bg-[#e94057] before:top-[50%] before:left-0 pl-24 text-2xl before:translate-y-[-50%] text-center w-fit m-auto max-sm:before:w-16 max-sm:pl-20'>LATEST BLOGS</p>
          ...
          {blog.map((val)=>(
            <div key={val.img} className='group'>
              <div className=' flex justify-center items-center relative overflow-hidden '>
                 ...
                 <p className='absolute bottom-0 left-0 text-2xl bg-color-pattern text-white p-6 max-lg:p-4'>{val.date} Jan</p>
              </div>
              ...
              <div className=' p-8 max-lg:p-5'>
                ...
                <p className=' cursor-pointer hover:text-[#e94057] font text-2xl font-bold w-[70%] max-lg:w-[100%] max-lg:text-lg'>
                  {val.desc}
                </p>
              </div>
            </div>
